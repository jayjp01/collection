(function () {
    ...
    angular
        .module('wizard.dashboard', ['ui.bootstrap'])


    .controller('storeController', StoreController)
        .factory('dataFactory', dataFactory);

    StoreController.$inject = ['$scope', '$uibModal', '$window', 'dataFactory', 'wantAdTree'];


    function StoreController($scope, $uibModal, $window, dataFactory, wantAdTree) {
        var modalInstance;
