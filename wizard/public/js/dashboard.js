...
(function () {
    ...
    angular
        .module('wizard.dashboard')

    .controller('dashboardController', DashboardController)
        .factory('dashboardFactory', DashboardFactory);
    DashboardController.$inject = ['$scope', 'dashboardFactory','wantAdTree'];


    function DashboardController($scope, dashboardFactory,wantAdTree) {
        $scope.dashboard = {};
        $scope.log = wantAdTree.menu.items;
        (function () {
